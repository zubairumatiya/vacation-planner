...
export async function emailSender(userEmail, subject, text, BASE_URL, path, token) {
    ...
    await mg.messages.create("sandbox0ee2e840946d4bec9838876781bfe078.mailgun.org", {
